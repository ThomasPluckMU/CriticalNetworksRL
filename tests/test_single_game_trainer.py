...
class TestSingleGameTrainer:
    ...
    def test_init(self, mock_keyboard, mock_atari):
        ...
        config = {"memory_size": 50000, "render": False, "save_dir": "test_checkpoints"}
    ...
    def test_make_env(self, mock_keyboard, mock_atari):
        ...
        with patch("gym.make") as mock_gym:
            ...
            mock_gym.assert_called_once_with("Pong", render_mode="human")
            assert env == "env"
    ...
    def test_save_checkpoint(
        self, mock_makedirs, mock_exists, mock_save, mock_keyboard, mock_atari
    ):
